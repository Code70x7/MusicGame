...
const imgMap = new Map([
  ["c1", "assets/chicken.png"],
  ["b", "assets/boy.png"],
  ["a", "assets/alligator.png"],
  ["g", "assets/gecko.png"],
  ["f", "assets/fox.png"],
  ["e", "assets/eagle.png"],
  ["d", "assets/dog.png"],
  ["c2", "assets/chicken.png"],
]);
...
function startNote(note) {
  ...
  newNote.style.width = "125px";
  newNote.src = imgMap.get(note);
  // if (note === 'c2') {
  //     newNote.src = 'assets/notec.png';
  // } else {
  //     newNote.src = 'assets/note.png';
  // }
...
function playGame() {
  ...
  document.getElementById("body").addEventListener("keydown", (event) => {
    ...
    if (event.key == matchSeq[0]) {
      document.getElementById(audioMap.get(matchSeq[0])).play();
      const audioElement = document.getElementById(audioMap.get(matchSeq[0]));
      audioElement.volume = 0.1; // Adjust the volume here
      audioElement.play();
