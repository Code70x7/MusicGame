...
const FULL_DASH_ARRAY = 283;
        ...
        function scoreCard() {
            document.getElementById("score").innerHTML = `Times Up! You got <strong>${score}</strong> correct.`;
        ...
        function timeCalc() {
            let time = ((startPos - endPos) * noteSpeed / 1000) + ((noteNum) * noteInterval / 1000)
        ...
        function slideNote(noteNode) {
            ...
            let pushNote = setInterval(() => {
                if (xPosition < endPos && document.contains(noteNode)) { // Change final xPosition based on location of end of staff
